...
{
    /// <summary>id生成器， 简易使用雪花算法 机器码为1 数据码为1</summary>
    public static class IdHelper
    {
        private static SnowflakeNet _snowflakeNet;
    ...
    /// <summary>
    /// 雪花算法 摘自 https://gitee.com/yswenli/SAEA/blob/master/Src/SAEA.Common/SnowflakeNet.cs 0 -
    ...
    public class SnowflakeNet
    {
        ...
        /// <summary>防止产生的时间比之前的时间还要小（由于NTP回拨等问题）,保持增量的趋势</summary>
